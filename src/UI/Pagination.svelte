...
<span>
  ...
  results {pagination.currentPage == 1 ? 1 : pagination.limit * pagination.currentPage - pagination.limit + 1}
  - {pagination.current * pagination.limit >= pagination.totalRows ? pagination.totalRows : pagination.currentPage * pagination.limit < pagination.totalRows ? pagination.currentPage * pagination.limit : pagination.totalRows}
